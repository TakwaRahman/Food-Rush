...
const Navbar = () => {
    ...
    const Li = <>
        ...
        <li ><NavLink to='/dashboard' className={({ isActive }) => `font-semibold ${isActive ? 'text-orange-500' : 'text-black hover:text-orange-500'}`}>Dashboard</NavLink></li>
        ...
        <li ><NavLink to='/add-restaurents' className={({ isActive }) => `font-semibold ${isActive ? 'text-orange-500' : 'text-black hover:text-orange-500'}`}>Add Restaurents</NavLink></li>
